...
export default function Page() {
  return (
    <main>
      ...
      <br />
      <Link href="week-8" className='text-xl font-bold'>Week 8</Link>
      <br />
      <Link href="week-9" className='text-xl font-bold'>Week 9</Link>
      <br />
      <Link href="week-10" className='text-xl font-bold'>Week 10</Link>
      </main>
  );
}